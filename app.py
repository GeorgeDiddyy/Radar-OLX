...
ID_CHAT = "8921969479"
INTERVAL_VERIFICARE = 45  # Scanează la fiecare 45 de secunde

# --- LISTA TA DE CĂUTĂRI OLX ---
# Poți înlocui link-urile de mai jos cu ale tale. Pune mereu VIRGULĂ între ele!
LISTA_CAUTARI = [
    "https://www.olx.ro/electronice-si-electrocasnice/telefoane-mobile/arges-judet/q-iphone-sigilat/?currency=RON&search%5Border%5D=created_at:desc&search%5Bfilter_float_price:from%5D=1500&search%5Bfilter_float_price:to%5D=20000&search%5Bfilter_enum_state%5D%5B0%5D=new",
...
def scaneaza_olx():
    ...
    try:
        # Scriptul ia la rând fiecare link din lista ta
            ...
            for link in links:
                ...
                if "/d/anunt/" in url_anunt and "-ID" in url_anunt:
                    ...
                    if id_anunt not in anunturi_vechi:
                        ...
                        # Alerta se trimite doar dacă apare un anunț proaspăt publicat
                        if not prima_rulare:
                            mesaj_alerta = f"🔥 PRODUS NOU DETECTAT PE OLX!\n\n👉 Deschide Anunțul: {url_complet}"
                            trimite_telegram(mesaj_alerta)
                            
    except Exception as e:
        pass

# Pornire radar în cloud
scaneaza_olx()
if prima_rulare:
